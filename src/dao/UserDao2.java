...
public static List<User> getUser(String  user_id){
...
public static void updateTwo(String user_id,String name,String password) {
	String able="1";
	String sql = "UPDATE user SET  name = '" + name + "',password= '" + password + "',able= '" + able + "'where user_id= '" + user_id + "'";
