...
body {
  background: #616161 url(images/readbook.jpg) center/cover no-repeat;
  height: 100vh;
  overflow: hidden;
  color: #FFF;
}
...
.change-language-btn {
    ...
    top: -6px;
    right: -6px;
    background: url(images/change-language-btn-bg.png) no-repeat;
    font-size: 16px;
    color: #fff;
...
<a class="home" href="homepage.jsp">HOME PAGE</a>
<div class="login-box">
<div class="login-bag">      		  
<a class="change-language-btn" href="doLanguage.jsp?language=<%=language%>"><fmt:message  bundle="${myKey}" key="language"/></a>  
...
<form id="fm1" class="fm-v clearfix" action="/bfish/login.do" method="post" onsubmit="return check()">
	...
	<div class="login-submit-box">
		...
		<p class="login-submit-box-forget">
				<a href="/bfish/reader/forget/one.jsp" target="_blank"><fmt:message  bundle="${myKey}" key="forget"/></a></a>
		</p>
	</div>
