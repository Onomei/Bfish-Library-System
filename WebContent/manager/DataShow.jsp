...
<tr><td><font size="6">Fine</font></td> <td><font size="6"> ${ data["fine"]}  RMB</font></td> <td> <button  onclick="myFunction1()" >change </button></td></tr>
...
<tr><td><font size="6">Deposit</font></td> <td><font size="6">${ data["deposit"]}  RMB</font></td><td><button  onclick="myFunction3()" >change</button></td></tr>
